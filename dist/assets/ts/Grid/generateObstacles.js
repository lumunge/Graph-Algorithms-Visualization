import { rowSize, colSize } from "./gridIndex";
...
export const setObstacles = () => {
    ...
    var obstacleValue = (document.querySelector(".obstacleSlider")).value;
    ...
    var arr1 = rows.slice(), arr2 = cols.slice();
    arr1.sort(function () {
    ...
    var trimVal = Math.floor((arr1.length * obstacleValue) / (rowSize + colSize));
    arr1.splice(0, arr1.length - trimVal);
    while (arr1.length) {
        var rowVal = arr1.pop(), colVal = arr2[0] == rowVal ? arr2.pop() : arr2.shift();
